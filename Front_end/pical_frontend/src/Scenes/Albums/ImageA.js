...
class ImageA extends Component {
  render() {
    return (
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="column">
                <a
                  href="https://unsplash.it/800/444.jpg?image=251"
                ...
                <a
                  href="https://unsplash.it/800/444.jpg?image=252"
                  data-toggle="lightbox"
                  data-gallery="gallery"
                >
                  <img
                ...
                <a
                  href="https://unsplash.it/800/444.jpg?image=253"
                  data-toggle="lightbox"
                  data-gallery="gallery"
                >
                  <img
