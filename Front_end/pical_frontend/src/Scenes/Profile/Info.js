                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 col-12">
                            ...
                            <div className="row username">
                                ...
                                <div className="col-md-8">
                                    <input type="password" className="form-control" placeholder="Password" aria-label="Recipient's username" aria-describedby="basic-addon2" />
                                </div>
                            </div>
                            {/* end password */}
                            <div className="row username">
                            ...
                            <div className="row username">
                                ...
                                <div className="col-md-8">
                                    <input type="text" className="form-control" placeholder="Title" aria-label="Recipient's username" aria-describedby="basic-addon2" />
                                </div>
                            </div>
                            {/* title */}
                            <div className="row button">
                                ...
                                <div className="col-md-4 button-mobile">
                                    <div className="row" />
                                    <a href="account.html" className="btn btn-info cancel">Cancel</a>
                                    <a href="chatroom.html" className="btn btn-info ok">Ok</a>
                                </div>
                            </div>
                        </div>
                    </div>
