      ...
      <div className="team-development">
        <div className="container">
          <div className="row">
            ...
            <div className="col-8">
              <i>
                "We are a hard-working team that is fully focused on high-end
                programs and functional apps for our clients."
              </i>
            </div>
          </div>
          <div className="row team-info">
            <div
              className="col-4 text-center wow bounceInLeft"
              data-wow-delay="0s"
            ...
            <div
              className="col-4 text-center wow bounceInRight"
              data-wow-delay="0s"
              data-wow-duration="1.7s"
            >
              <div className="image-info">
